package com.muj_unity_fest_backend.aop;
...
public class BackendAspects {
	...
	// setup the Logger
		...
		@Pointcut("execution(* com.muj_unity_fest_backend.controller.*.*(..))")
		private void forControllerPackage() {
			LOGGER.info("LoginUserController class is being executed");
		}
		@Pointcut("com.muj_unity_fest_backend.service.*.*(..))")
		private void forServicePackage() {
			LOGGER.info("LoginUserService class is being executed");
		}
		@Pointcut("com.muj_unity_fest_backend.repository.*.*(..))")
